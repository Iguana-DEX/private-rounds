...
export class TotalClaimed extends ethereum.Event {
  get params(): TotalClaimed__Params {
    return new TotalClaimed__Params(this);
  }
}

export class TotalClaimed__Params {
  _event: TotalClaimed;

  constructor(event: TotalClaimed) {
    this._event = event;
  }
...
export class ClaimTotalEthPledgedCall extends ethereum.Call {
  get inputs(): ClaimTotalEthPledgedCall__Inputs {
    return new ClaimTotalEthPledgedCall__Inputs(this);
  }

  get outputs(): ClaimTotalEthPledgedCall__Outputs {
    return new ClaimTotalEthPledgedCall__Outputs(this);
  }
}

export class ClaimTotalEthPledgedCall__Inputs {
  _call: ClaimTotalEthPledgedCall;

  constructor(call: ClaimTotalEthPledgedCall) {
    this._call = call;
  }
...
export class ClaimTotalEthPledgedCall__Outputs {
  _call: ClaimTotalEthPledgedCall;
