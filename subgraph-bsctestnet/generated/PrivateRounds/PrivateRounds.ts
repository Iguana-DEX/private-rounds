...
export class TotalEthPledgedChanged extends ethereum.Event {
  get params(): TotalEthPledgedChanged__Params {
    return new TotalEthPledgedChanged__Params(this);
  }
}

export class TotalEthPledgedChanged__Params {
  _event: TotalEthPledgedChanged;

  constructor(event: TotalEthPledgedChanged) {
    this._event = event;
  }
...
export class PrivateRounds extends ethereum.SmartContract {
  ...
  getPledgedAmount(_roundId: BigInt, memberAddress: Address): BigInt {
    let result = super.call(
      "getPledgedAmount",
      "getPledgedAmount(uint32,address):(uint256)",
      [
  ...
  getTotalEthPledged(_roundId: BigInt): BigInt {
    let result = super.call(
      "getTotalEthPledged",
      "getTotalEthPledged(uint32):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    );
  ...
  try_getTotalEthPledged(_roundId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTotalEthPledged",
      "getTotalEthPledged(uint32):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
  ...
  rounds(param0: BigInt): PrivateRounds__roundsResult {
    let result = super.call(
      "rounds",
      "rounds(uint256):(uint256,uint256,uint256,uint256,uint32,uint32,bool,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
...
export class ChangeRoundInfoCall extends ethereum.Call {
  get inputs(): ChangeRoundInfoCall__Inputs {
    return new ChangeRoundInfoCall__Inputs(this);
  }

  get outputs(): ChangeRoundInfoCall__Outputs {
    return new ChangeRoundInfoCall__Outputs(this);
  }
}

export class ChangeRoundInfoCall__Inputs {
  _call: ChangeRoundInfoCall;

  constructor(call: ChangeRoundInfoCall) {
    this._call = call;
  }
...
export class ChangeRoundInfoCall__Outputs {
  _call: ChangeRoundInfoCall;
...
export class GrantMemberRoleCall__Inputs {
  ...
  get newMemberAddresses(): Array<Address> {
...
export class RevokeMemberRoleCall__Inputs {
  ...
  get oldMemberAddresses(): Array<Address> {
    return this._call.inputValues[0].value.toAddressArray();
  }
}
