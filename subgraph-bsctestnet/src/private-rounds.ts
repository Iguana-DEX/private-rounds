import {
  ...
  TotalEthPledgedChanged as TotalEthPledgedChangedEvent,
...
export function handleTotalEthPledgedChanged(
  event: TotalEthPledgedChangedEvent
): void {
  let entity = new TotalEthPledgedChanged(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.groupAddress = event.params.groupAddress
  entity.roundId = event.params.roundId
  entity.totalEthPledged = event.params.totalEthPledged
