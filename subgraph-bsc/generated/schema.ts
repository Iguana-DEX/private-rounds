...
export class GroupInfoChanged extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save GroupInfoChanged entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type GroupInfoChanged must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("GroupInfoChanged", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): GroupInfoChanged | null {
    return changetype<GroupInfoChanged | null>(
      store.get("GroupInfoChanged", id.toHexString())
    );
  }
...
export class PrivateRoundsRoleAdminChanged extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save PrivateRoundsRoleAdminChanged entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PrivateRoundsRoleAdminChanged must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set(
  ...
  static load(id: Bytes): PrivateRoundsRoleAdminChanged | null {
    return changetype<PrivateRoundsRoleAdminChanged | null>(
      store.get("PrivateRoundsRoleAdminChanged", id.toHexString())
    );
  }
...
export class PrivateRoundsRoleGranted extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save PrivateRoundsRoleGranted entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PrivateRoundsRoleGranted must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PrivateRoundsRoleGranted", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): PrivateRoundsRoleGranted | null {
    return changetype<PrivateRoundsRoleGranted | null>(
      store.get("PrivateRoundsRoleGranted", id.toHexString())
    );
  }
...
export class PrivateRoundsRoleRevoked extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save PrivateRoundsRoleRevoked entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PrivateRoundsRoleRevoked must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PrivateRoundsRoleRevoked", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): PrivateRoundsRoleRevoked | null {
    return changetype<PrivateRoundsRoleRevoked | null>(
      store.get("PrivateRoundsRoleRevoked", id.toHexString())
    );
  }
...
export class RoundInfoChanged extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save RoundInfoChanged entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type RoundInfoChanged must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("RoundInfoChanged", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): RoundInfoChanged | null {
    return changetype<RoundInfoChanged | null>(
      store.get("RoundInfoChanged", id.toHexString())
    );
  }
  ...
  get roundTitle(): string {
    let value = this.get("roundTitle");
    return value!.toString();
  }

  set roundTitle(value: string) {
    this.set("roundTitle", Value.fromString(value));
  }

  get roundStory(): string {
    let value = this.get("roundStory");
    return value!.toString();
  }

  set roundStory(value: string) {
    this.set("roundStory", Value.fromString(value));
  }

  get roundImageUrl(): string {
    let value = this.get("roundImageUrl");
    return value!.toString();
  }

  set roundImageUrl(value: string) {
    this.set("roundImageUrl", Value.fromString(value));
  }

  get roundInfoUrl(): string {
    let value = this.get("roundInfoUrl");
    return value!.toString();
  }

  set roundInfoUrl(value: string) {
    this.set("roundInfoUrl", Value.fromString(value));
  }
...
export class TotalEthPledgedChanged extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save TotalEthPledgedChanged entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type TotalEthPledgedChanged must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("TotalEthPledgedChanged", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): TotalEthPledgedChanged | null {
    return changetype<TotalEthPledgedChanged | null>(
      store.get("TotalEthPledgedChanged", id.toHexString())
    );
  }
  ...
  get totalEthPledged(): BigInt {
    let value = this.get("totalEthPledged");
    return value!.toBigInt();
  }

  set totalEthPledged(value: BigInt) {
    this.set("totalEthPledged", Value.fromBigInt(value));
  }
